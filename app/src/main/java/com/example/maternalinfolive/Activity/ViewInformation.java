...
public class ViewInformation extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            hide_add_btn();
            List = new ArrayList<>();
            adapter = new Info_Adapter(ViewInformation.this, List);



            recyclerView =findViewById(R.id.info_recycle);
            recyclerView.setHasFixedSize(true);
            LinearLayoutManager linearLayoutManager=new LinearLayoutManager(ViewInformation.this);
    ...
    //        saloon_name.setText(String.valueOf(sharedPreferences.getString("saloon_name",null)));
        ...
        public void view_all_posts(){
            final ProgressDialog dialog = new ProgressDialog(ViewInformation.this);
                ...
                protected void onPostExecute(String string1) {
                    ...
                    try {
                        if(string1.equals("found") || string1.contains("found")){
                            ...
                            Toast.makeText(ViewInformation.this, ""+string1, Toast.LENGTH_SHORT).show();
...
//                            finish();
        ...
        public void add_staff_fab(View view) {
            startActivity(new Intent(ViewInformation.this,NewPostActivity.class));
        }
